        ...
        async def on_console(msg):
            if msg.type == "error":
                ...
                if hasattr(msg, 'location') and msg.location:
                    error_details['filename'] = msg.location.get('url', 'Unknown')
                    error_details['lineno'] = msg.location.get('lineNumber', 'Unknown')
                    error_details['colno'] = msg.location.get('columnNumber', 'Unknown')
                
                # Try to extract error details from the message text
                if msg.text:
